...
name=llama3_1_8B_cot_demo_nofilter
accelerate launch \
  ...
  --lora_alpha 16 \
  --lora_dropout 0.05 \
  --train_file /home/ubuntu/scalable-factuality/train/train_cot/size_reasoning_path_cont_v3_0_1_372-size_reasoning_path_anli_561.jsonl \
  --max_seq_length 2048 \
