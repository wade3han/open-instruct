...
accelerate launch \
  ...
  --lora_alpha 16 \
  --lora_dropout 0.05 \
  --train_file /home/ubuntu/scalable-factuality/train/train_cot/size_final_reasoning_path_cont_v3_0_1_8000-size_final_reasoning_path_anli_8000.jsonl \
  --max_seq_length 2048 \
