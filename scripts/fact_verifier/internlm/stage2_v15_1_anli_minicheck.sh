...
name=internlm_stage2_v15_1_anli_minicheck_bsz16
accelerate launch \
  ...
  --wandb_name $name \
  --model_name_or_path /home/ubuntu/open-instruct-general/internlm_v15_1_anli_minicheck_bsz16 \
  --tokenizer_name /home/ubuntu/open-instruct-general/internlm_v15_1_anli_minicheck_bsz16 \
  --trust_remote_code \
  --use_slow_tokenizer \
