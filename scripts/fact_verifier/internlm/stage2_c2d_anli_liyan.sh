...
name=internlm_stage2_c2d_anli_liyan_1e-5
accelerate launch \
  ...
  --wandb_name $name \
  --model_name_or_path /home/ubuntu/open-instruct-general/internlm_c2d_anli_liyan \
  --tokenizer_name /home/ubuntu/open-instruct-general/internlm_c2d_anli_liyan \
  --trust_remote_code \
  --use_slow_tokenizer \
