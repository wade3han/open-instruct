...
name=llama32_1B_cont_v3_0_2_8k_anli_8k_2eps_2048_seed1
accelerate launch \
...
name=llama32_1B_cont_v3_0_2_8k_anli_8k_2eps_2048_seed2
accelerate launch \
  --mixed_precision bf16 \
  --num_machines 1 \
  --num_processes $NUM_GPUS \
...
name=llama32_1B_cont_v3_0_2_8k_anli_8k_2eps_2048_seed42
accelerate launch \
  --mixed_precision bf16 \
  --num_machines 1 \
  --num_processes $NUM_GPUS \
