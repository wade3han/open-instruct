...
name=llama32_1B_c2d_anli_8k_2eps_2048
accelerate launch \
  ...
  --lora_alpha 16 \
  --lora_dropout 0.05 \
  --train_file /home/ubuntu/scalable-factuality/train/train/size_anli_64k_8000.jsonl,/home/ubuntu/scalable-factuality/train/train/c2d.jsonl \
  --max_seq_length 2048 \
