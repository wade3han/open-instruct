...
name=llama32_1B_mt_v5_2_anli_filtered_2eps_2048
accelerate launch \
  ...
  --lora_alpha 16 \
  --lora_dropout 0.05 \
  --train_file /home/ubuntu/scalable-factuality/train/train_filtered/v5_2-anli.jsonl,/home/ubuntu/scalable-factuality/train/train_cot/v5_2-anli.jsonl \
  --max_seq_length 2048 \
