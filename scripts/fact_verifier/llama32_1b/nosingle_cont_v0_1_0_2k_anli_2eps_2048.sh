...
name=llama32_1B_nosingle_cont_v0_1_0_2k_anli_2eps_2048
accelerate launch \
  ...
  --lora_alpha 16 \
  --lora_dropout 0.05 \
  --train_file /home/ubuntu/scalable-factuality/train/train/size_nosingle_cont_v0_1_0_2000-anli.jsonl \
  --max_seq_length 2048 \
