...
name=llama32_1B_dv_stepbystep_alignscore_2eps
accelerate launch \
  ...
  --lora_alpha 128 \
  --lora_dropout 0.05 \
  --train_file /home/ubuntu/scalable-factuality/train/train/size_cont_v3_0_1_8000-alignscore.jsonl,/home/ubuntu/scalable-factuality/train/train_cot/step_by_step_v3_cont_v3_0_1-alignscore.jsonl \
  --max_seq_length 2048 \
