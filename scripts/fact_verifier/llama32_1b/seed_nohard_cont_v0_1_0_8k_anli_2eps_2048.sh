...
name=llama32_1B_nohard_cont_v0_1_0_8k_anli_8k_2eps_2048_seed1
accelerate launch \
  ...
  --lora_alpha 16 \
  --lora_dropout 0.05 \
  --train_file /home/ubuntu/scalable-factuality/train/train/size_nohard_cont_v0_1_0_8000-size_anli_64k_8000.jsonl \
  --max_seq_length 2048 \
...
name=llama32_1B_nohard_cont_v0_1_0_8k_anli_8k_2eps_2048_seed2
accelerate launch \
  --mixed_precision bf16 \
  --num_machines 1 \
  --num_processes $NUM_GPUS \
