...
name=llama32_1B_nomulti_cont_v0_1_0_cont_v2_0_3_anli_2eps_2048
accelerate launch \
  ...
  --lora_alpha 16 \
  --lora_dropout 0.05 \
  --train_file /home/ubuntu/scalable-factuality/train/train/cont_v2_0_3-anli-nomulti_cont_v0_1_0.jsonl \
  --max_seq_length 2048 \
