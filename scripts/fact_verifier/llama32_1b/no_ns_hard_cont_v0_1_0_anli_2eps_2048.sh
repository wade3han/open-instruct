...
name=llama32_1B_cont_no_ns_hard_v0_1_0_8k_anli_2eps_2048
accelerate launch \
  ...
  --lora_alpha 16 \
  --lora_dropout 0.05 \
  --train_file /home/ubuntu/scalable-factuality/train/train/size_no_ns_hard_cont_v0_1_0_8000-anli.jsonl \
  --max_seq_length 2048 \
