...
NAME=tulu2mix_batch4_seq8192_mask-user_reduce-loss-sum_v1_filter-skills
...
gantry run --beaker-image seungjuh/open-instruct-public-240711 --venv base \
  ...
  --train_file /net/nfs.cirrascale/mosaic/seungjuh/open-instruct/datasets/tulu-v2-sft-mixture_train_wildtagger_skill_filtered.jsonl \
  --max_seq_length 8192 \
