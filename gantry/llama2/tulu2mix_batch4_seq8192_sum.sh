...
NAME=tulu2mix_batch4_seq8192_new-open-instruct_reduce-loss-sum
...
gantry run --beaker-image seungjuh/open-instruct-public-240711 --venv base \
  ...
  --train_file /net/nfs.cirrascale/mosaic/seungjuh/open-instruct/datasets/tulu-v2-sft-mixture.jsonl \
  --max_seq_length 8192 \
