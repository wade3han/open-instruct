...
NAME=megamixv2_batch4_seq8192_sum_lr5e-5_wsd20_user_mask_a100
...
gantry run --beaker-image seungjuh/open-instruct-public-240711 --venv base \
  ...
  --train_file /net/nfs.cirrascale/mosaic/seungjuh/open-instruct/datasets/megamixv2_dedup_train.jsonl \
  --max_seq_length 8192 \
