...
NAME=tulu2_cooldown_random_batch4_seq8192_sum_lr5e-5_user_mask
...
gantry run --beaker-image seungjuh/open-instruct-public-240711 --venv base \
  ...
  --train_file /net/nfs.cirrascale/mosaic/seungjuh/open-instruct/datasets/megamix_minhash-3gram-0_5_train/random600000.jsonl \
  --max_seq_length 8192 \
